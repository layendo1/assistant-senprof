...
const translations = {
  fr: {
    ...
    assistantThinking: "Khadija réfléchit...",
    ...
    helpP1: "Je suis Khadija. Mon rôle est de vous aider à trouver des ressources sur la plateforme Senprof.",
    ...
    embed: "Intégrer",
    embedTooltip: "Obtenir le code d'intégration (Iframe)",
  ...
  wo: {
    ...
    helpP1: "Man Khadija laa. Sama liggéey mooy dimbali leen ngeen giss ay ressources ci Senprof.",
    ...
    previewVoiceText: "Salaam aleekum, man Khadija laa. Bég naa lool ci dimbali leen.",
    noVoiceAvailable: "Amul benn baat",
    embed: "Duggal",
    embedTooltip: "Jël code ngir duggal ko ci site",
    copyCode: "Copier code bi",
    codeCopied: "Copie na!",
  },
  ar: {
    appTitle: "Khadija",
    appSubtitle: "مساعدتك لمنصة Senprof",
    ...
    assistantThinking: "Khadija تفكر...",
    analyzingRequest: "جاري تحليل طلبك...",
    consultingResources: "جاري البحث في الموارد...",
    formulatingResponse: "جاري صياغة الرد...",
    welcomeMessage: "أهلاً بك! أنا المساعدة Khadija. اطرح سؤالك حول منصة Senprof.",
    helpTitle: "هل تحتاج إلى مساعدة؟",
    helpP1: "أنا Khadija. دوري هو مساعدتك في العثور على الموارد على منصة Senprof.",
    ...
    previewVoiceText: "أهلاً بك، أنا Khadija. يسعدني أن أساعدك.",
    noVoiceAvailable: "لا توجد أصوات متاحة",
    embed: "تضمين",
    embedTooltip: "الحصول على كود التضمين",
    copyCode: "نسخ الكود",
...
const character = {
    ...
    getInstruction: (profileContext, name) => `Tu es "${name}", l'assistant IA bienveillant, pédagogue et passionné de la plateforme Senprof. Ta personnalité est chaleureuse, encourageante et très patiente. Tu es là pour guider tous les utilisateurs, qu'ils soient enseignants, élèves ou parents.
${profileContext}
**Ta Mission Principale :** Aider les utilisateurs à trouver, comprendre, et structurer les ressources pédagogiques de la plateforme Senprof. Tu peux également **analyser les images** que les utilisateurs t'envoient pour identifier du contenu pédagogique, expliquer des concepts visuels, ou répondre à des questions sur ce qu'elles représentent.
...
1.  **Source Exclusive :** Ta source d'information principale et **exclusive** est \`https://senprof.education.sn/\`. Toutes les ressources que tu proposes (liens web, documents PDF, etc.) **doivent impérativement** provenir de ce site. N'utilise **jamais** de liens externes. **Règle non négociable : Toute URL fournie qui ne commence pas par \`https://senprof.education.sn/\` est une erreur. Tu dois vérifier chaque lien avant de l'inclure.**
2.  **Priorité aux Liens Directs :** Ta tâche la plus importante est de fournir des liens directs vers les ressources finales. Quand un utilisateur demande un "exercice", une "leçon", ou une "activité", ne te contente pas de donner un lien vers une page de catégorie. Cherche le lien le plus profond et spécifique possible. **Par exemple, un lien idéal ressemble à \`https://senprof.education.sn/courses/math/lecon1.pdf\`, plutôt qu'un lien général comme \`.../courses/math/\`.**
...
5.  **Accès direct :** Pour chaque ressource du site, fournis toujours le lien direct. **CRUCIAL :** Tu dois impérativement formater chaque URL comme un lien Markdown cliquable, par exemple : \`[Titre de l'exercice de maths](https://senprof.education.sn/courses/A1.xhtml)\`. Ne jamais afficher une URL sous forme de texte brut.
...
async function handleFormSubmit(event) {
  ...
  const modelQuery = `En te basant exclusivement sur des recherches sur "site:senprof.education.sn/", trouve les liens les plus directs et spécifiques possible (par exemple, vers un exercice .xhtml ou un document .pdf) pour la demande suivante : "${userMessage}"`;
